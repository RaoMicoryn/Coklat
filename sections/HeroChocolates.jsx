  ...
  return (
    <>
      ...
      <div className="flex justify-center items-start gap-6">
        <div>
          <img src={activeFlavor === 'caramel' ? CaramelOpen : Caramel} alt="Caramel" className='relative z-10 caramel-choco max-w-72.5 mt-18 drop-shadow-[0_10px_40px_rgba(255,107,87,0.5)]' />
        </div>
        <div>
        ...
        <div className='relative'>
          ...
          <img src={Stamp} alt="Stamp" className='stamp absolute z-10 max-w-37.5 -top-15 -left-30 transform rotate-32' />
        </div>
      </div>
    </>
  )
