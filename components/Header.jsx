...
const Header = () => {
  ...
  return (
    <>
    <header className='sticky top-0 z-20 flex items-strech justify-between gap-5 max-w-7xl m-auto p-6'>
            ...
            <nav>
                <ul className='flex items-center gap-9 font-medium tracking-tight'>
                    ...
                    <li>
                        ...
                        <img src={Gift} className='max-w-11 pb-2' alt=''/>
                        </a>
                    </li>
                </ul>
            </nav>
        </div>
        <a href='' className='flex items-center justify-center bg-white rounded-xl text-nowrap px-4 py-3 font-medium gap-3'>
            Explore Flavours
